"""Tests for aion.cosmos.observing and catalogs."""

import math

from aion.cosmos.catalogs import load_bright_stars, load_messier, load_planets
from aion.cosmos.constants import J2000
from aion.cosmos.observing import air_mass, build_sky_catalog, moon_phase, whats_up, whats_up_all
...
def test_log_observation_sqlite(tmp_path, monkeypatch):
    from aion.cosmos.observations import list_observations, log_observation
