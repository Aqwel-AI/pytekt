/*
 * Aqwel-Aion — fast astronomy calculations (universe module)
 *
 * Optional native module: aion._aion_universe
...
PYBIND11_MODULE(_aion_universe, m) {
    m.doc() = "Fast astronomy kernels for aion.universe";
