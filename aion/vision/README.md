...
> Not for charts/plots. Use [`aion.visualization`](../visualization/) for matplotlib/seaborn.
...
```python
from aion.vision import read_image, write_image, resize, canny, draw_box, psnr
...
```bash
aion vision info photo.jpg
aion vision convert in.jpg out.png --mode RGB --size 256x256
aion vision edges in.jpg edges.png --t1 80 --t2 160
```
...
```bash
python -m aion.vision.examples.demo_read_write
python -m aion.vision.examples.demo_transforms
python -m aion.vision.examples.demo_edges
```
