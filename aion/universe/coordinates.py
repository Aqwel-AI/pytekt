...
from .time import gmst, julian_centuries
from .units import deg_to_rad, hours_to_deg, rad_to_deg
...
def angular_separation(
    ...
    from ._native import angular_separation_deg
...
def equatorial_to_galactic(ra_hours: float, dec_deg: float) -> Tuple[float, float]:
    """Equatorial J2000 (RA hours, Dec deg) to galactic (l, b) degrees."""
    from ._native import equatorial_to_galactic as _eq_gal
...
def equatorial_to_horizontal(
    ...
    Returns (altitude_deg, azimuth_deg) where azimuth is measured from north eastward.
    """
    from ._native import equatorial_to_horizontal as _eq_hor
...
def horizontal_to_equatorial(
    ...
    """Horizontal to equatorial (RA hours, Dec deg)."""
    from ._native import horizontal_to_equatorial as _hor_eq
...
def precess(
    ...
    """
    from ._native import precess as _precess_native
