...
class Component:
    ...
    Examples
    --------
    >>> from aion.ui import Component, html
...
def function_component(
    ...
    Examples
    --------
    >>> from aion.ui import html, function_component
    >>> @function_component
    ... def Title(props):
    ...
    wrapper._is_aion_component = True  # type: ignore[attr-defined]
    return wrapper
...
def render_component(component: Any) -> str:
    ...
    if callable(component) and getattr(component, "_is_aion_component", False):
