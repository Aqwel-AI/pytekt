...
The `aion.algorithms` package now includes **570+** registered functions across 21 categories.

## Discover algorithms

```python
from aion.algorithms import count_algorithms, list_algorithms, get_algorithm, categories
