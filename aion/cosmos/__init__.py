"""
Aion Cosmos — lightweight astronomy toolkit.

Coordinates, time, observing, orbits, cosmology, catalogs, and optional plots.

Examples
--------
>>> from aion.cosmos import equatorial_to_horizontal, moon_phase, now_jd
...
from .pipeline import CosmosCatalogStep, CosmosPlotStep
