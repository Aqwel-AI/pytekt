...
def cosmos_main(args: argparse.Namespace) -> None:
    action = getattr(args, "cosmos_action", None) or "help"
    ...
    if action == "web":
        from .launch import run_cosmos_dashboard
    ...
    print("  Usage: aion cosmos moon | sky | coords | separation | web | demo")
