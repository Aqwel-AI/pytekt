...
from pytekt.universe.core.constants import J2000
...
def gmst(jd: float) -> float:
    ...
    from pytekt.universe.core._native import gmst_hours

    return gmst_hours(jd)


def lst(jd: float, longitude_deg: float) -> float:
    """Local Sidereal Time in hours."""
    from pytekt.universe.core._native import lst_hours

    return lst_hours(jd, longitude_deg)
