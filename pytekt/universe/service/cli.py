...
from pytekt.universe.astrometry.coordinates import angular_separation, equatorial_to_horizontal
from pytekt.universe.ephemeris.observing import moon_phase, whats_up
from pytekt.universe.core.time import now_jd
...
def universe_main(args: argparse.Namespace) -> None:
    ...
    if action == "demo":
        from pytekt.universe.examples.demo_coordinates import main

        main()
        return

    if action == "web":
        from pytekt.universe.service.launch import run_universe_dashboard
