"""Pipeline steps for universe workflows."""

from __future__ import annotations

from typing import Any, Dict, List, Optional

from pytekt.pipeline.core import Step


class UniverseCatalogStep(Step):
    """Load a builtin catalog into pipeline data."""

    name = "universe_catalog"
    ...
    def run(self, data: Any, ctx: Dict[str, Any]) -> Any:
        from pytekt.universe.catalogs import catalogs
