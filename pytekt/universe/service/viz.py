"""Cosmos visualizations (requires matplotlib / pytekt[viz])."""
...
def _require_matplotlib():
    try:
        ...
        raise ImportError(
            "matplotlib required for pytekt.universe.viz. Install with: pip install pytekt[viz]"
        ) from e
    return plt
...
plot_skymap = plot_sky_map
plot_orbit = plot_orbit_2d
