...
from pytekt.universe.core.constants import AU, J2000, MU_SUN
from pytekt.universe.core.time import julian_centuries
...
def kepler_third_law(a: float, mu: float) -> float:
    ...
    from pytekt.universe.core._native import kepler_third_law as _ktl
...
def mean_anomaly_from_true(nu_deg: float, e: float) -> float:
    from pytekt.universe.core._native import mean_anomaly_from_true as _mft
...
def true_anomaly_from_mean(M_deg: float, e: float, *, tol: float = 1e-8) -> float:
    ...
    from pytekt.universe.core._native import true_anomaly_from_mean as _tfm
...
def position_from_elements(
    ...
    *,
    ...
    from pytekt.universe.core._native import position_from_elements as _pfe
...
def hohmann_transfer(r1: float, r2: float, mu: float) -> Dict[str, float]:
    ...
    from pytekt.universe.core._native import hohmann_transfer as _hohmann
...
def planet_position(planet_name: str, jd: float) -> Dict[str, float]:
    ...
    from pytekt.universe.core._native import planet_ecliptic_position
