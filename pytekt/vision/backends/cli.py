...
def vision_main(args: argparse.Namespace) -> None:
    ...
    if action == "info":
        from pytekt.vision.core.io import image_info
    ...
    if action == "convert":
        from pytekt.vision.core.io import read_image, write_image
        from pytekt.vision.geometry.transforms import resize
    ...
    if action == "edges":
        from pytekt.vision.processing.filters import canny
        from pytekt.vision.core.io import read_image, write_image
