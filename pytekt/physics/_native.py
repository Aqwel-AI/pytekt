"""
Optional C++ extension bridge for :mod:`pytekt.physics`.

Uses ``pytekt._pytekt_physics`` when built; otherwise pure-Python fallbacks.
"""
...
try:
    from pytekt._pytekt_physics import (
